...
function ProductDetailContent() {
  ...
  useEffect(() => {
    if (productSlug) {
      const product = spicesProducts.find((p) => p.slug === productSlug)
  ...
  const viewProduct = (slug: string) => {
    router.push(`/products/spices?product=${slug}`)
  }

  const backToListing = () => {
    router.push("/products/spices")
  }
                ...
                <Tabs defaultValue="features" className="mb-8">
                  ...
                  <TabsContent value="features" className="p-4 bg-gray-50 rounded-md mt-2">
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
                        <span>Authentic flavor and aroma</span>
                      </li>
                      <li className="flex items-start">
                        <Check className="h-5 w-5 text-green-500 mr-2 mt-0.5" />
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[40vh] flex items-center">
        ...
        <div className="container relative z-10 mx-auto px-4 text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Spices Products</h1>
          <p className="text-xl max-w-2xl">Authentic, flavorful, and sustainably sourced spice varieties</p>
        </div>
      </section>
      ...
      <section className="py-8 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8">Our Spices Products</h2>
